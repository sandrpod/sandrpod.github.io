...
Two defects, and a third thing that looked like one. Neither defect appeared in
unit tests. The first failed *silently* — returning something shaped like an
answer. The second failed loudly, at the wrong thing.
